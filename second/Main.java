...
public class Main 
{
	public static void main(String[] args) 
	{
        ...
        CriteriaQuery<Employee> criteria=cb.createQuery(Employee.class);//result
        criteria.from(Employee.class);// entity
        Query<?> q=session.createQuery(criteria);
        List<?> results = q.getResultList(); // here query will get fired
        ...
        results = q.getResultList(); // query gets fired
        System.out.println(results);
